public class Dog {
    ...
    //constructors
    public Dog(String name, String sound, String owner, String color, int age,
               int size) {
        this.name = name;
        this.sound = sound;
        this.owner = owner;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Dog))
            return false;
        Dog dog = (Dog)o;
        return age == dog.age && size == dog.size && name.equals(dog.name) &&
            owner.equals(dog.owner) && sound.equals(dog.sound) &&

...
class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nMatrix 1 contains 6: " +
                           containsValue(intArray1, 6));
        System.out.println("Matrix 1 contains 11: " +
                           containsValue(intArray1, 11));
        System.out.println("\nSum of Matrix 1: " + sumOfArray(intArray1));
        System.out.println("\nEvery row in Matrix 1 has the same sum: " +
                           isRowMagic(intArray1));
        System.out.println("Every row in Matrix 2 has the same sum: " +
                           isRowMagic(intArray2));
    }

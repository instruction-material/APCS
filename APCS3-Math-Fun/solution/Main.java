...
class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The number " + base + " to the power of " + power +
                           " is " + baseToPower);

        double sqrt = Math.sqrt(baseToPower);
        System.out.println("The square root of " + baseToPower +
                           " is: " + sqrt);

        double fourthRoot = Math.sqrt(sqrt);
        System.out.println("The fourth root of " + baseToPower +
                           " is: " + fourthRoot);

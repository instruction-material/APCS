...
class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter \"true\" or \"false\" to the following "
        ...
        if (safeLeft) {
            if (safeRight) {
                if (!isScared) {
                    System.out.println(
                        "You are ready to cross the street by yourself!");
                } else {
                    if (hasHen) {
                        System.out.println(
                            "You can cross with your mother hen!");
                    } else {
                        System.out.println(
                            "You are scared and alone, so you might want to "
                            + "find a Hen or Rooster!");
                    }
                }
            } else {

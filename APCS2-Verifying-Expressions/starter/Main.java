class Main
{
	public static void main(String[] args) {
		/* Work through all of the questions below before running the code to verify your answers! */
		...
		// What does the above line output? Answer here before uncommenting and running the line of code to verify your guess.
